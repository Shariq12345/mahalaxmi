    ...
    const fetchProjects = async () => {
      try {
        const response = await fetch(
          "http://localhost/mahalaxmi/app/backend/api/projects.php?category=retail"
        );
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-light mb-6">
              Our <span className="font-semibold">Retail</span> Projects
            </h1>
            <p className="text-lg md:text-xl text-gray-200">
              Explore our portfolio of exceptional interior designs for retail
